...
output_csv_path = 'C:\\Users\\EDEM\\Downloads\\DATAPROJECT4\\intentoleakyrelu.csv'
...
model = Sequential([
    Conv2D(32, kernel_size=(3, 3), activation=LeakyReLU(alpha=0.1), input_shape=(new_size[0], new_size[1], 1)),
    BatchNormalization(),
    MaxPooling2D(pool_size=(2, 2)),
    Conv2D(64, kernel_size=(3, 3), activation=LeakyReLU(alpha=0.1)),
    BatchNormalization(),
    MaxPooling2D(pool_size=(2, 2)),
    Flatten(),
...
#¡¡¡¡¡¡YA HEMOS PROBADO: RELU, LEAKYRELU, !!!!!!!!!
